...
public class Hospital {
    ...
    private static void mostrarMenu() {
        ...
        System.out.println("6. Cargar datos de contacto del Hospital desde Archivo de Texto.");
        System.out.println("7. Guardar Historial de pacientes en archivo.");
        System.out.println("8. Recuperar Historial de pacientes desde archivo.");
    ...
    private static void cargarDoctoresIniciales() {
        ...
        doctores.add(new Doctor("Dr. Messi", "89231232", "10/10/1960", "Traumatologo"));
        doctores.add(new Doctor("Dr. Nico", "98286122", "19/02/1999", "Kinesiologo"));
        doctores.add(new Doctor("Dr. Sanchez", "12345678", "10/09/1975", "Nutricionista"));
        doctores.add(new Doctor("Dr. Cholo", "12873722", "02/02/1920", "Clinico"));
    }
